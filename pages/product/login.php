    ...
    <div class="wrapper d-flex wrapper-dark-bg">
        <div class="container my-auto">
            <div class="col-lg-4 col-md-6 mx-auto">
                <form name="myForm" class="form" method="POST" action="./loginValid.php">
                    <div class="card card-login">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="pwd" placeholder="密碼" class="form-control">
                            </div>
                            <br>
                            <div class="input-group">
                                <input type="radio" name="identity" value="admin">賣家
                                <input type="radio" name="identity" value="users">買家
                            </div>
