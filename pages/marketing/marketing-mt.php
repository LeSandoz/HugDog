...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <h4>marketing_type</h4>
                <div class="card">
                    <div class="card-header">
                        <form name="myForm" method="POST" action="marketing-mt-search.php">
                    ...
                    <div class="card-body">
                        <form name="myForm" method="POST" action="marketing-deleteIds-mt.php">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="marketing-new-mt.php" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i> 新增優惠</a>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                LIMIT ?, ? ";
                                    ...
                                    ?>
                                            <tr>
                                                <td class="text-center"><input type="checkbox" name="chk[]" value="<?php echo $arr[$i]['mtId']; ?>" /></td>
                                                ...
                                                <td>
                                                    <a href="./marketing-edit-mt.php?editId=<?php echo $arr[$i]['mtId']; ?>" class="btn btn-info btn-icon btn-sm">
