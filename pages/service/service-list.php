...
<body id="page-top">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="mb-2">
                    ...
                    <button type="button" class="btn btn-success ml-3" onclick="addFunc('service-list')"><i class="fa fa-plus"></i> 新增資料</button>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form name="form2" id="form2" method="POST">
                            <div class="row justify-content-between">
                                <div class="col-auto">
                                    <button class="btn btn-sm btn-danger" type="button" onclick="delCheckedFunc('service-list')"><i class="fa fa-trash"></i> 刪除勾選</button>
                                    <!-- <button class="btn btn-sm btn-info"><i class="fa fa-edit"></i> 編輯勾選</button> -->
                                </div>
                                <div class="col-auto form-inline">
                                    <label>每頁</label>
                                    <select name="numPerPage" class="form-control-sm mx-2" onchange="pageFunc('service-list','reset')">
                                        <?php
                                        //分頁功能
                                        //預設查詢sql
                                        $sql = "SELECT count(*) as count FROM `service_list`";
                                        //分頁查詢功能
                                        //查詢總筆數
    ...
    <!-- service-list-onload.js -->
    <script src="./js/service-list-onload.js"></script>
</body>
