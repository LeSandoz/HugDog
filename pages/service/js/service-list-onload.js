...
$(document).on('submit', '#formAddData', function (e) {
    if (e.isDefaultPrevented()) {
        ...
        $.ajax({
            method: 'POST',
            url: './service-list-ajax.php',
            data: {
                act: 'serviceAddData',
                sListId: $(`#serviceModal input[name='sListId']`).val(),
                sListName: $(`#serviceModal input[name='sListName']`).val(),
                sListInfo: $(`#serviceModal textarea[name='sListInfo']`).val(),
