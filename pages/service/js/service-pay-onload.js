...
$(document).on('submit', '#formAddData', function (e) {
    if (e.isDefaultPrevented()) {
        ...
        $.ajax({
            method: 'POST',
            url: './service-pay-ajax.php',
            data: {
                act: 'serviceAddData',
                sPayId: $(`#serviceModal input[name='sPayId']`).val(),
                sPayName: $(`#serviceModal input[name='sPayName']`).val(),
                sPayInfo: $(`#serviceModal textarea[name='sPayInfo']`).val(),
