...
city[1]=new Option('台北縣','1');town[1][0]=new Option('207萬里鄉','0');town[1][1]=new Option('208金山鄉','1');town[1][2]=new Option('220板橋市','2');town[1][3]=new Option('221汐止市','3');town[1][4]=new Option('222深坑鄉','4');town[1][5]=new Option('223石碇鄉','5');town[1][6]=new Option('224瑞芳鎮','6');town[1][7]=new Option('226平溪鄉','7');town[1][8]=new Option('227雙溪鄉','8');town[1][9]=new Option('228貢寮鄉','9');town[1][10]=new Option('231新店市','10');town[1][11]=new Option('232坪林鄉','11');town[1][12]=new Option('233烏來鄉','12');town[1][13]=new Option('234永和市','13');town[1][14]=new Option('235中和市','14');town[1][15]=new Option('236土城市','15');town[1][16]=new Option('237三峽鎮','16');town[1][17]=new Option('238樹林市','17');town[1][18]=new Option('239鶯歌鎮','18');town[1][19]=new Option('241三重市','19');town[1][20]=new Option('242新莊市','20');town[1][21]=new Option('243泰山鄉','21');town[1][22]=new Option('244林口鄉','22');town[1][23]=new Option('247蘆洲市','23');town[1][24]=new Option('248五股鄉','24');town[1][25]=new Option('249八里鄉','25');town[1][26]=new Option('251淡水鎮','26');town[1][27]=new Option('252三芝鄉','27');town[1][28]=new Option('253石門鄉','28');
...
city[4]=new Option('桃園市','4');town[4][0]=new Option('320中壢區','0');town[4][1]=new Option('324平鎮區','1');town[4][2]=new Option('325龍潭區','2');town[4][3]=new Option('326楊梅區','3');town[4][4]=new Option('327新屋區','4');town[4][5]=new Option('328觀音區','5');town[4][6]=new Option('330桃園區','6');town[4][7]=new Option('333龜山區','7');town[4][8]=new Option('334八德區','8');town[4][9]=new Option('335大溪區','9');town[4][10]=new Option('336復興區','10');town[4][11]=new Option('337大園區','11');town[4][12]=new Option('338蘆竹鄉','12');
city[5]=new Option('300新竹市','5');town[5][0]=new Option('300','0');
...
city[9]=new Option('台中市','9');town[9][0]=new Option('411太平區','0');town[9][1]=new Option('412大里區','1');town[9][2]=new Option('413霧峰區','2');town[9][3]=new Option('414烏日區','3');town[9][4]=new Option('420豐原區','4');town[9][5]=new Option('421后里區','5');town[9][6]=new Option('422石岡區','6');town[9][7]=new Option('423東勢鎮','7');town[9][8]=new Option('424和平區','8');town[9][9]=new Option('426新社區','9');town[9][10]=new Option('427潭子區','10');town[9][11]=new Option('428大雅區','11');town[9][12]=new Option('429神岡區','12');town[9][13]=new Option('432大肚區','13');town[9][14]=new Option('433沙鹿區','14');town[9][15]=new Option('434龍井區','15');town[9][16]=new Option('435梧棲區','16');town[9][17]=new Option('436清水區','17');town[9][18]=new Option('437大甲區','18');town[9][19]=new Option('438外埔區','19');town[9][20]=new Option('439大安區','20');
...
city[16]=new Option('台南市','16');town[16][0]=new Option('710永康區','0');town[16][1]=new Option('711歸仁區','1');town[16][2]=new Option('712新化區','2');town[16][3]=new Option('713左鎮區','3');town[16][4]=new Option('714玉井區','4');town[16][5]=new Option('715楠西區','5');town[16][6]=new Option('716南化區','6');town[16][7]=new Option('717仁德區','7');town[16][8]=new Option('718關廟區','8');town[16][9]=new Option('719龍崎區','9');town[16][10]=new Option('720官田區','10');town[16][11]=new Option('721麻豆區','11');town[16][12]=new Option('722佳里區','12');town[16][13]=new Option('723西港區','13');town[16][14]=new Option('724七股區','14');town[16][15]=new Option('725將軍區','15');town[16][16]=new Option('726學甲區','16');town[16][17]=new Option('727北門區','17');town[16][18]=new Option('730新營區','18');town[16][19]=new Option('731後壁區','19');town[16][20]=new Option('732白河區','20');town[16][21]=new Option('733東山區','21');town[16][22]=new Option('734六甲區','22');town[16][23]=new Option('735下營區','23');town[16][24]=new Option('731柳營區','24');town[16][25]=new Option('737鹽水區','25');town[16][26]=new Option('741善化區','26');town[16][27]=new Option('742大內區','27');town[16][28]=new Option('743山上區','28');town[16][29]=new Option('745安定區','29');town[16][30]=new Option('744新市區','30');
...
city[18]=new Option('高雄市','18');town[18][0]=new Option('814仁武區','0');town[18][1]=new Option('815大社區','1');town[18][2]=new Option('820岡山鎮','2');town[18][3]=new Option('821路竹區','3');town[18][4]=new Option('822阿蓮區','4');town[18][5]=new Option('823田寮區','5');town[18][6]=new Option('824燕巢區','6');town[18][7]=new Option('825橋頭區','7');town[18][8]=new Option('826梓官區','8');town[18][9]=new Option('827彌陀區','9');town[18][10]=new Option('828永安區','10');town[18][11]=new Option('829湖內區','11');town[18][12]=new Option('830鳳山區','12');town[18][13]=new Option('831大寮區','13');town[18][14]=new Option('832林園區','14');town[18][15]=new Option('833鳥松區','15');town[18][16]=new Option('840大樹區','16');town[18][17]=new Option('842旗山區','17');town[18][18]=new Option('843美濃鎮','18');town[18][19]=new Option('844六龜區','19');town[18][20]=new Option('845內門區','20');town[18][21]=new Option('846杉林區','21');town[18][22]=new Option('847甲仙區','22');town[18][23]=new Option('848桃源區','23');town[18][24]=new Option('849三民區','24');town[18][25]=new Option('851茂林區','25');town[18][26]=new Option('852茄萣區','26');
