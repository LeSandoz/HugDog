                    ...
                    <div class="card-body">
                        <form name="myForm" method="POST" action="member-deleteIds.php">
                                ...
                                ?>
                                    <thead>
                                        <tr>
                                            ...
                                            if ($filter3 == "1") {
                                            ?>
                                                <th class=" bd">會員性別 <a href="./member-bday-ASC.php"> ∥</a></th>
                            ...
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="<?= "?page=" . $pagep . "&mId=" . $filter . "&mName=" . $filter1 . "&mAccount=" . $filter2 . "&mPassword=" . $filter8 . "&mGender=" . $filter3 . "&mBday=" . $filter4 . "&mPhone=" . $filter5 . "&mEmail=" . $filter6 . "&mAddress=" . $filter7  ?>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                                    <?php for ($i = 1; $i <= $totalPages; $i++) { ?>

                                <li class="page-item"><a class="page-link" href="<?= "?page=" . $i . "&mId=" . $filter . "&mName=" . $filter1 . "&mAccount=" . $filter2 . "&mPassword=" . $filter8 . "&mGender=" . $filter3 . "&mBday=" . $filter4 . "&mPhone=" . $filter5 . "&mEmail=" . $filter6 . "&mAddress=" . $filter7 ?>"><?= $i ?></a>
                                <?php } ?></li>
                                <li class="page-item">
                                    <a class="page-link" href="<?= "?page=" . $pagen . "&mId=" . $filter . "&mName=" . $filter1 . "&mAccount=" . $filter2 . "&mPassword=" . $filter8 . "&mGender=" . $filter3 . "&mBday=" . $filter4 . "&mPhone=" . $filter5 . "&mEmail=" . $filter6 . "&mAddress=" . $filter7  ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
